...
public class KoeVoer {
	...
	public KoeVoer(int oornr, int voer_id, float max, float gegeten) {
		super();
		this.oornr = oornr;
	...
	public KoeVoer(int oornr) {
		this.oornr = oornr;
	}
	public KoeVoer(int voer_id, float max, float gegeten) {
		this.voer_id = voer_id;
		this.max = max;
		this.gegeten = gegeten;
	}
